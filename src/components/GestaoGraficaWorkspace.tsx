...
export function GestaoGraficaWorkspace({ workspace, scope = "all" }: { workspace?: GraphicWorkspace; scope?: "all" | "mine" } = {}) {
  ...
  const allTabs: GraphicTabMeta[] = [
    ...
    { key: "production", label: "PCP", count: String(productionRows.length), title: "PCP e producao", description: "Acompanhe ordens, checklist, materiais, tempos, bloqueios e evidencias.", action: "Executar ordem" },
