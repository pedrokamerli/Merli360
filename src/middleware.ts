...
const publicPaths = ["/login", "/api/login", "/manifest.webmanifest", "/icon.svg", "/sw.js", "/catalog-studium-products.png", "/q", "/api/public-questionnaires", "/api/gestao-grafica/public-quotes", "/api/gestao-grafica/public-catalog", "/api/gestao-grafica/catalog/images", "/public/orcamento", "/public/catalogo"];
